...
const handleSubmit = () => {
    if (subscription.id) {
        form.put(route('admin.event.update', subscription.id), {
            preserveScroll: true,
            onError: (errors) => {
                            ...
                            <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2 grid grid-cols-2 gap-10">
                                        <span class="inline-flex items-center gap-2 rounded-lg px-2 py-1"
                                              :class="{
                                        ...
                                        <span class="inline-flex items-center gap-2 rounded-lg border px-2 py-1"
                                              :class="{
                                                    'border-red-500 text-white': subscription.status === 2,
                                                  }">
