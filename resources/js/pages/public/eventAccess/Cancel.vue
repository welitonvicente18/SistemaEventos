...
import { XCircleIcon,LinkIcon } from '@heroicons/vue/24/outline';
        ...
        <div class="mx-auto max-w-7xl py-10 sm:px-6 sm:py-5 lg:px-8">
            ...
            >
                ...
                <div class="mx-auto text-center lg:mx-0 lg:py-22 lg:text-left">
                    <p class="inline-flex mt-6 text-2xl text-pretty text-gray-300">
                        <XCircleIcon class="h-7 w-7 text-red-600"/> Inscrição cancelada!
                    </p>
                    <div class="mt-10 gap-x-6 lg:justify-start">
                        <div class="mt-6 text-lg/8 text-pretty text-gray-300">
                            <b>{{ props.subscription.name }}</b>
                        </div><div class="mt-6 text-lg/8 text-pretty text-gray-300">
                            sua inscrição foi cancelada, para realizar novamente clique no botão abaixo!
                        </div>
                        <div class="mt-6 text-lg/8 text-pretty text-gray-300">
                            <a
